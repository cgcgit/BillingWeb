...
public class ConsumptionClassController extends BasicType<PtConsumptionClass> implements Serializable, IEditableTable {
	...
	public void loadDataList() {
		this.setDataList(consumptionClassEJB.findAllData());
