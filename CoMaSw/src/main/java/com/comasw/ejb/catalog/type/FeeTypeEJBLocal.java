...
public interface FeeTypeEJBLocal {
	...
	/**
	 * Find the fee type data stores in the system for the given feeTypeId and searchDate
	 * @param searchDate
	 * @param feeTypeId
	 * @return type data in the system for the given feeTypeId and searchDate
	 * @throws CoMaSwDataAccessException
	 */
	public CtFeeType findDataBySearchDateAndFeeTypeId (LocalDateTime searchDate, Integer feeTypeId) throws CoMaSwDataAccessException;
	...
	/**
	 * Find the fee type data stores in the system for the given code of fee type and searchDate
	 * @param searchDate
	 * @param code
	 * @return fee type data in the system for the given code of fee type and searchDate
	 * @throws CoMaSwDataAccessException
	 */
	public CtFeeType findDataBySearchDateAndCode (LocalDateTime searchDate,String code) throws CoMaSwDataAccessException;
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public List<CtFeeType> findDataBySearchDateAndApplicationLevelId(LocalDateTime searchDate,Integer applicationLevelId) throws CoMaSwDataAccessException;
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public List<CtFeeType> findDataBySearchDateAndApplicationLevelCode(LocalDateTime searchDate,String applicationLevelCode) throws CoMaSwDataAccessException;
	...
	/**
	 * Inserts into the system (database) the given new fee type. It creates a new Id and inserts into the id table.
	...
	/**
	 * Inserts into the system (database) a new historic data record for existing fee type 
	 * @param dataObject fee type object to insert
	 * @throws CoMaSwDataAccessException
	 */
