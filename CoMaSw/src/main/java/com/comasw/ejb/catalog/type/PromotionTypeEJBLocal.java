...
public interface PromotionTypeEJBLocal {
	...
	/**
	 * Find the promotion type data stores in the system for the given
	 * promotionTypeId and searchDate
	 * 
	 * @param searchDate
	 * @param promotionTypeId
	 ...
	 * 
	 * @param code
	 * @return promotion type data in the system for the given code of promotion
	 *         type
	 * @throws CoMaSwDataAccessException
	 */
	...
	/**
	 * Inserts into the system (database) the given new promotion type. It creates a
	 * new Id and inserts into the id table.
	 * 
