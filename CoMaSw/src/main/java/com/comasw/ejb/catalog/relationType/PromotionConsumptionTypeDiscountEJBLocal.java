...
public interface PromotionConsumptionTypeDiscountEJBLocal {
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public List <CtConsumptionType> findEntityTypeCandidates (Integer parentId, String statusCode) throws CoMaSwDataAccessException;
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public List<VwPromoConsumTypeDiscount> findRelatedEntityTypesView (Integer parentId) throws CoMaSwDataAccessException;
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public CtPromoConsumTypeDiscount findEntityRelationType (Integer entityRelationTypeId) throws CoMaSwDataAccessException;
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public CtPromoConsumTypeDiscount findEntityRelationType (Integer parentId, Integer childId) throws CoMaSwDataAccessException;
	 ...
	 * @throws CoMaSwDataAccessException
	 */
	public VwPromoConsumTypeDiscount findEntityRelationTypeView (Integer parentId, Integer childId) throws CoMaSwDataAccessException;
