...
public class PtConsumptionClassDao extends DAOImpl<PtConsumptionClassRecord, com.comasw.model.tables.pojos.PtConsumptionClass, Integer> {

    /**
     * Create a new PtConsumptionClassDao without any configuration
     */
    public PtConsumptionClassDao() {
        super(PtConsumptionClass.PT_CONSUMPTION_CLASS, com.comasw.model.tables.pojos.PtConsumptionClass.class);
    }
    ...
    public PtConsumptionClassDao(Configuration configuration) {
        super(PtConsumptionClass.PT_CONSUMPTION_CLASS, com.comasw.model.tables.pojos.PtConsumptionClass.class, configuration);
    }

    @Override
    public Integer getId(com.comasw.model.tables.pojos.PtConsumptionClass object) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchRangeOfConsumptionClassId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchByConsumptionClassId(Integer... values) {
     ...
     */
    public com.comasw.model.tables.pojos.PtConsumptionClass fetchOneByConsumptionClassId(Integer value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchRangeOfCode(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchByCode(String... values) {
     ...
     */
    public com.comasw.model.tables.pojos.PtConsumptionClass fetchOneByCode(String value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchByName(String... values) {
     ...
     */
    public com.comasw.model.tables.pojos.PtConsumptionClass fetchOneByName(String value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.PtConsumptionClass> fetchByDescription(String... values) {
