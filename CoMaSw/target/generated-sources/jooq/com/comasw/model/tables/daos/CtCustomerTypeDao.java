...
public class CtCustomerTypeDao extends DAOImpl<CtCustomerTypeRecord, com.comasw.model.tables.pojos.CtCustomerType, Integer> {

    /**
     * Create a new CtCustomerTypeDao without any configuration
     */
    public CtCustomerTypeDao() {
        super(CtCustomerType.CT_CUSTOMER_TYPE, com.comasw.model.tables.pojos.CtCustomerType.class);
    }
    ...
    public CtCustomerTypeDao(Configuration configuration) {
        super(CtCustomerType.CT_CUSTOMER_TYPE, com.comasw.model.tables.pojos.CtCustomerType.class, configuration);
    }

    @Override
    public Integer getId(com.comasw.model.tables.pojos.CtCustomerType object) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfCustomerTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByCustomerTypeId(Integer... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtCustomerType fetchOneByCustomerTypeId(Integer value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfEntityTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByEntityTypeId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfCode(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByCode(String... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtCustomerType fetchOneByCode(String value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByName(String... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtCustomerType fetchOneByName(String value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByDescription(String... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfStatusId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByStatusId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfInputDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByInputDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfInputUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByInputUser(String... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfModifDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByModifDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchRangeOfModifUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtCustomerType> fetchByModifUser(String... values) {
