...
public class CtPromoConsumTypeDiscountDao extends DAOImpl<CtPromoConsumTypeDiscountRecord, com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount, Integer> {

    /**
     * Create a new CtPromoConsumTypeDiscountDao without any configuration
     */
    public CtPromoConsumTypeDiscountDao() {
        super(CtPromoConsumTypeDiscount.CT_PROMO_CONSUM_TYPE_DISCOUNT, com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount.class);
    }
    ...
    public CtPromoConsumTypeDiscountDao(Configuration configuration) {
        super(CtPromoConsumTypeDiscount.CT_PROMO_CONSUM_TYPE_DISCOUNT, com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount.class, configuration);
    }

    @Override
    public Integer getId(com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount object) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfPromoConsumTypeDiscountId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByPromoConsumTypeDiscountId(Integer... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount fetchOneByPromoConsumTypeDiscountId(Integer value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfPromotionTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByPromotionTypeId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfConsumptionTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByConsumptionTypeId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfStatusId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByStatusId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfInputDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByInputDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfInputUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByInputUser(String... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfModifDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByModifDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchRangeOfModifUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoConsumTypeDiscount> fetchByModifUser(String... values) {
