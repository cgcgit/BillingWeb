...
public class CtPromoProdTypeDao extends DAOImpl<CtPromoProdTypeRecord, com.comasw.model.tables.pojos.CtPromoProdType, Integer> {

    /**
     * Create a new CtPromoProdTypeDao without any configuration
     */
    public CtPromoProdTypeDao() {
        super(CtPromoProdType.CT_PROMO_PROD_TYPE, com.comasw.model.tables.pojos.CtPromoProdType.class);
    }
    ...
    public CtPromoProdTypeDao(Configuration configuration) {
        super(CtPromoProdType.CT_PROMO_PROD_TYPE, com.comasw.model.tables.pojos.CtPromoProdType.class, configuration);
    }

    @Override
    public Integer getId(com.comasw.model.tables.pojos.CtPromoProdType object) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfPromoProdTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByPromoProdTypeId(Integer... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtPromoProdType fetchOneByPromoProdTypeId(Integer value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfPromotionTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByPromotionTypeId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfProductTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByProductTypeId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfStatusId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByStatusId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfInputDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByInputDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfInputUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByInputUser(String... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfModifDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByModifDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchRangeOfModifUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtPromoProdType> fetchByModifUser(String... values) {
