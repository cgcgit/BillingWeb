...
public class CtAccountType extends TableImpl<CtAccountTypeRecord> {
     ...
     */
    public final TableField<CtAccountTypeRecord, Integer> PAYMENT_METHOD_ID = createField(DSL.name("payment_method_id"), SQLDataType.INTEGER.nullable(false), this, "Payment method associated with the account type");
