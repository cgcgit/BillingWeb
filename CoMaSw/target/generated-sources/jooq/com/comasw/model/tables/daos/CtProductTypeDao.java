...
public class CtProductTypeDao extends DAOImpl<CtProductTypeRecord, com.comasw.model.tables.pojos.CtProductType, Integer> {

    /**
     * Create a new CtProductTypeDao without any configuration
     */
    public CtProductTypeDao() {
        super(CtProductType.CT_PRODUCT_TYPE, com.comasw.model.tables.pojos.CtProductType.class);
    }
    ...
    public CtProductTypeDao(Configuration configuration) {
        super(CtProductType.CT_PRODUCT_TYPE, com.comasw.model.tables.pojos.CtProductType.class, configuration);
    }

    @Override
    public Integer getId(com.comasw.model.tables.pojos.CtProductType object) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfProductTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByProductTypeId(Integer... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtProductType fetchOneByProductTypeId(Integer value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfEntityTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByEntityTypeId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfCode(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByCode(String... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtProductType fetchOneByCode(String value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByName(String... values) {
     ...
     */
    public com.comasw.model.tables.pojos.CtProductType fetchOneByName(String value) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByDescription(String... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfStatusId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByStatusId(Integer... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfInputDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByInputDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfInputUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByInputUser(String... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfModifDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByModifDate(LocalDateTime... values) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchRangeOfModifUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.comasw.model.tables.pojos.CtProductType> fetchByModifUser(String... values) {
