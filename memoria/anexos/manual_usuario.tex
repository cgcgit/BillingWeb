...
Una vez seleccionado se nos mostrará el listado de todos los usuarios del sistema (figura
...
\underline{\textsl{\textbf{Crear nueva entida}}}\newline
...
\underline{\textsl{\textbf{Borrar ciclo de facturación}}}\newline
...
Un tipo de cuenta viene definido por los elementos indicados en la tabla \ref{tab:tipo-cuenta}(página \pageref{tab:tipo-cuenta}):
...
\underline{\textsl{\textbf{Borrar tipo de cuenta}}}\newline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth]{imaxes/añadir-registro-historico-tipo-cuota.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.70\textwidth]{imaxes/listado-historico-tipo-consumo-tras-añadir.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.70\textwidth]{imaxes/confirmación-cambio-estado-cancelado.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.30\textwidth]{imaxes/botones-añadir-eliminar-relacion-tipos.png}
...
\underline{\textsl{\textbf{Borrar registro de histórico del servicio}}}\newline
Esta operación sólo está disponible para usuarios con permisos de edición.
...
Una vez finaliza la introducción de datos se pulsará el botón \emph{OK} que confirma la operación del formulario de creación. Si todo es correcto se registra la cuota en el sistema y se muestran los datos dla cuota creado la pantalla de visualización de la entidad.
...
Una vez finaliza la introducción de datos se pulsará el botón \emph{OK} que confirma la operación del formulario de creación. Si todo es correcto se registra la promoción en el sistema y se muestran los datos dla promoción creado la pantalla de visualización de la entidad.
