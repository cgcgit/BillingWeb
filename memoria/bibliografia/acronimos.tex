...
\newacronym{cdi}{CDI}{Contexto e inyección de dependencias o \textit{Contexts and Dependency Injection}}
...
\newacronym{jooq}{jOOQ}{Java Object Orientated Query}
...
\newacronym{uml}{UML}{Lenguale de modelado unificado o \textit{Unified
 ...
 \newacronym{xhtml}{XHTML}{Lenguaje de marcado de hipertexto extensible o \textit{eXtensible HyperText Markup Language}}
  \newacronym{crud}{CRUD}{Create (crear), Read (leer), Update (actualizar) y Delete (eliminar)}
\newacronym{saas}{SaaS}{Software como servicio o \textit{Sofware as a Service}}
\newacronym{bi}{BI}{Inteligencia empresarial o \textit{Business Intelligence}}
\newacronym{mrp}{MRP}{Planificación de requisitos de fabricación o \textit{manufacturing requirements planning}}
\newacronym{licencia}{GPL-3.0-or-later}{GNU General Public License version 3 o posterior}