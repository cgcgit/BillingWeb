...
\newglossaryentry{swpropietario}{
  name=software propietario o privativo,
  description={Denominación utilizada para referirse a cualquier programa informático cuyo código fuente sólo es accesible para su desarrollador (entendiéndose como tal la persona física o jurídica que posee los derechos de autor sobre dicho código fuente) quien además puede controlar y restringir los derechos de usuario sobre dicho programa permitiendo su ejecución sólo bajo ciertas condiciones.
     }     
}