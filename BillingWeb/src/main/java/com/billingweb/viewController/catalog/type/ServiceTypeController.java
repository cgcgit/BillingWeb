 ...
 *
 */
public class ServiceTypeController extends SimpleTableBasicClassWithLists implements Serializable, IGeneralController {
	...
	String DATA_TABLE_ID = "form:" + ServiceTypeController.uiValues.getString("dataTableID");
	String NEW_PANEL_DATA_ID = "form:" + ServiceTypeController.uiValues.getString("newPanelDataID");
	 ...
	 * Entity data list
	 */
	private List<CtServiceType> dataList;

	/**
	 * Application level filtered data list
	 */
	private List<CtServiceType> filteredDataList;
	 ...
	 */
	private CtServiceType backupData;
	 ...
	 * @return the dataList
	 */
	public List<CtServiceType> getDataList() {
		return dataList;
	}
	 ...
	 */
	public void setDataList(List<CtServiceType> dataList) {
	 ...
	 */
	public List<CtServiceType> getFilteredDataList() {
	 ...
	 */
	public void setFilteredDataList(List<CtServiceType> filteredDataList) {
	 ...
	 */
	public CtServiceType getBackupData() {
		return backupData;
	}
	 ...
	 */
	public void setBackupData(CtServiceType backupData) {
	...
	public void init() {
		...
		if (this.backupData == null) {
			this.backupData = new CtServiceType();
		}
	...
	public void loadDataList() {
		dataList = serviceTypeEJB.findAllData();
		if (dataList.isEmpty()) {
