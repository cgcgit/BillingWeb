 ...
 *
 */
public class ProductTypeController extends SimpleTableBasicClassWithLists implements Serializable, IGeneralController {
	...
	String DATA_TABLE_ID = "form:" + ProductTypeController.uiValues.getString("dataTableID");
	String NEW_PANEL_DATA_ID = "form:" + ProductTypeController.uiValues.getString("newPanelDataID");
	 ...
	 * Entity data list
	 */
	private List<CtProductType> dataList;

	/**
	 * Application level filtered data list
	 */
	private List<CtProductType> filteredDataList;
	 ...
	 */
	private CtProductType backupData;
	 ...
	 * @return the dataList
	 */
	public List<CtProductType> getDataList() {
		return dataList;
	}
	 ...
	 */
	public void setDataList(List<CtProductType> dataList) {
	 ...
	 */
	public List<CtProductType> getFilteredDataList() {
	 ...
	 */
	public void setFilteredDataList(List<CtProductType> filteredDataList) {
	 ...
	 */
	public CtProductType getBackupData() {
		return backupData;
	}
	 ...
	 */
	public void setBackupData(CtProductType backupData) {
	...
	public void init() {
		...
		if (this.backupData == null) {
			this.backupData = new CtProductType();
		}
	...
	public void loadDataList() {
		dataList = productTypeEJB.findAllData();
		if (dataList.isEmpty()) {
