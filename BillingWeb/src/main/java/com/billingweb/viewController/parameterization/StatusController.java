 ...
 *
 */
public class StatusController extends SimpleTableBasicClass implements Serializable, IGeneralController {
	...
	String DATA_TABLE_ID = "form:" + StatusController.uiValues.getString("dataTableID");
	String NEW_PANEL_DATA_ID = "form:" + StatusController.uiValues.getString("newPanelDataID");
	 ...
	 */
	private List<PtStatus> dataList;

	/**
	 * Application level filtered data list
	 */
	private List<PtStatus> filteredDataList;
	 ...
	 * @return the dataList
	 */
	public List<PtStatus> getDataList() {
		return dataList;
	}
	 ...
	 */
	public void setDataList(List<PtStatus> dataList) {
	 ...
	 */
	public List<PtStatus> getFilteredDataList() {
	 ...
	 */
	public void setFilteredDataList(List<PtStatus> filteredDataList) {
	 ...
	 */
	public void setBackupData(PtStatus backupData) {
	...
	public void loadDataList() {
		dataList = statusEJB.findAllData();
		if (dataList.isEmpty()) {
