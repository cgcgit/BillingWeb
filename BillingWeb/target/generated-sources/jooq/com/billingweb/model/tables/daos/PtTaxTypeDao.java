...
public class PtTaxTypeDao extends DAOImpl<PtTaxTypeRecord, com.billingweb.model.tables.pojos.PtTaxType, Integer> {

    /**
     * Create a new PtTaxTypeDao without any configuration
     */
    public PtTaxTypeDao() {
        super(PtTaxType.PT_TAX_TYPE, com.billingweb.model.tables.pojos.PtTaxType.class);
    }
    ...
    public PtTaxTypeDao(Configuration configuration) {
        super(PtTaxType.PT_TAX_TYPE, com.billingweb.model.tables.pojos.PtTaxType.class, configuration);
    }

    @Override
    public Integer getId(com.billingweb.model.tables.pojos.PtTaxType object) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchRangeOfTaxTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchByTaxTypeId(Integer... values) {
     ...
     */
    public com.billingweb.model.tables.pojos.PtTaxType fetchOneByTaxTypeId(Integer value) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchRangeOfCode(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchByCode(String... values) {
     ...
     */
    public com.billingweb.model.tables.pojos.PtTaxType fetchOneByCode(String value) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchByName(String... values) {
     ...
     */
    public com.billingweb.model.tables.pojos.PtTaxType fetchOneByName(String value) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchByDescription(String... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchRangeOfPercentValue(BigDecimal lowerInclusive, BigDecimal upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.PtTaxType> fetchByPercentValue(BigDecimal... values) {
