...
public class CtProdServTypeDao extends DAOImpl<CtProdServTypeRecord, com.billingweb.model.tables.pojos.CtProdServType, Integer> {

    /**
     * Create a new CtProdServTypeDao without any configuration
     */
    public CtProdServTypeDao() {
        super(CtProdServType.CT_PROD_SERV_TYPE, com.billingweb.model.tables.pojos.CtProdServType.class);
    }
    ...
    public CtProdServTypeDao(Configuration configuration) {
        super(CtProdServType.CT_PROD_SERV_TYPE, com.billingweb.model.tables.pojos.CtProdServType.class, configuration);
    }

    @Override
    public Integer getId(com.billingweb.model.tables.pojos.CtProdServType object) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfProdServTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByProdServTypeId(Integer... values) {
     ...
     */
    public com.billingweb.model.tables.pojos.CtProdServType fetchOneByProdServTypeId(Integer value) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfProductTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByProductTypeId(Integer... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfServiceTypeId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByServiceTypeId(Integer... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfStatusId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByStatusId(Integer... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfInputDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByInputDate(LocalDateTime... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfInputUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByInputUser(String... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfModifDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByModifDate(LocalDateTime... values) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchRangeOfModifUser(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.billingweb.model.tables.pojos.CtProdServType> fetchByModifUser(String... values) {
