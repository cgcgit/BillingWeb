...
public class VwUsers extends TableImpl<VwUsersRecord> {
    ...
    private VwUsers(Name alias, Table<VwUsersRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"vw_users\" as  SELECT u.user_id,\n    u.user_code,\n    u.password,\n    u.profile_id,\n    p.profile_code\n   FROM (it_users u\n     JOIN it_profiles p ON ((u.profile_id = p.profile_id)))\n  WHERE (u.active = true);"));
    }
