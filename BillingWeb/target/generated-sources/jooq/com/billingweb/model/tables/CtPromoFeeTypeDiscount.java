...
public class CtPromoFeeTypeDiscount extends TableImpl<CtPromoFeeTypeDiscountRecord> {
    ...
    public CtPromotionType ctPromotionType() {
        if (_ctPromotionType == null)
            _ctPromotionType = new CtPromotionType(this, Keys.CT_PROMO_FEE_TYPE_DISCOUNT__CT_PROMO_FEE_TYPE_DISCOUNT_PROMO_FK);
    ...
    public CtFeeType ctFeeType() {
        if (_ctFeeType == null)
            _ctFeeType = new CtFeeType(this, Keys.CT_PROMO_FEE_TYPE_DISCOUNT__CT_PROMO_FEE_TYPE_DISCOUNT_FEE_FK);
